        ...
        <View style={styles.menuCard}>
          ...
          >
            <View style={[styles.menuIconBg, { backgroundColor: 'rgba(255, 193, 7, 0.15)' }]}>
              <Ionicons name="calendar-outline" size={20} color="#FFC107" style={styles.menuIcon} />
            </View>
          ...
          >
            <View style={[styles.menuIconBg, { backgroundColor: 'rgba(103, 58, 183, 0.15)' }]}>
              <Ionicons name="notifications-outline" size={20} color="#673AB7" style={styles.menuIcon} />
            </View>
